...
<div class="container">
<a class="navbar-brand" href="<?php echo SITE_URL; ?>">Trainer Fit Backend</a>
<form name="searching" action="<?php echo SITE_URL; ?>/controller/search" method="GET" class="navbar-form navbar-left" role="search">
